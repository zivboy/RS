...
(function ($, w, d, undefined) {
    ...
    var NewsBox = {
        ...
        onPrev: function() {
            ...
            var obj = $(self.$elem).find(self.newsTagName).last();

            var html = '<' + self.newsTagName + ' style="display:none;" class="' + self.newsClassName + '" id = "'+obj.attr("id")+'" >' + obj.html() + '</' + self.newsTagName + '>';
        ...
        onNext: function() {
            ...
            var obj = $(self.$elem).find(self.newsTagName).first();

            var html = '<' + self.newsTagName + ' style="display:none;" class="' + self.newsClassName + '" id = "'+obj.attr("id")+'">' + obj.html() + '</' + self.newsTagName + '>';
            $(self.$elem).append(html);

            obj.slideUp(self.options.animationSpeed, function(){
                $(this).remove();
            });
